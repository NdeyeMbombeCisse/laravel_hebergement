                ...
                <div class="card" style="width: 90%;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="btn-center">
                            ...
                            @auth
                            <a href="supprimer/{{ $produit->id }}" class="btn btn-danger m-1"><img class="icon" src="https://cdn-icons-png.flaticon.com/512/1214/1214428.png" alt=""></a>
                            <a href="modifier_produit/{{ $produit->id }}" class="btn btn-primary m-1"><img class="icon" src="https://cdn.icon-icons.com/icons2/916/PNG/512/Edit_icon-icons.com_71853.png" alt=""></a>  
