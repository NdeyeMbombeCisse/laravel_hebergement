...
.categorie{
  ...
  <body>
    <header>
        <nav style="display: flex; justify-content: center;">
            ...
            @auth
            <a href="#" onclick="document.getElementById('logout-form').submit()"><form action="{{ url('deconnexion') }}" method="POST" id="logout-form">@csrf</form>Deconnexion</a> 
  ...
  .categorie{
    ...
    <body>
      <header>
          <nav style="display: flex; justify-content: center;">
              <a href="{{ url('afficher_produit') }}">Les produits</a>
                        ...
                        <div class="col-md-3">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="bouton">
                                        @auth
                                        <a href="{{ url('supprimer/' . $produit->id) }}" class="btn btn-danger m-1"><i class="fa-solid fa-trash" style="color: white;"></i></a>
                                        <a href="{{ url('modifier_produit/' . $produit->id) }}" class="btn btn-primary m-1"><i class="fa-solid fa-square-pen"></i></a>  
                                      @endauth
                                    </div>
                                </div>
                            </div>
